...
if check_password():
    ...
    P_in= st.sidebar.number_input('Pressure inlet (bara):',value=5.39,min_value=1.0,step=0.1, max_value=100.0) 
    P_out= st.sidebar.number_input('Pressure out (bara):',value=5.3,min_value=0.1,step=0.1, max_value=100.0)
